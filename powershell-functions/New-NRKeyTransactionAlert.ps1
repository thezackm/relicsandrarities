...
<#
.SYNOPSIS 
    Function to create New Relic Transaction Alert
...
.EXAMPLE
    New-NRKeyTransactionAlert -AdminAPIKey '123456789ABCDEFGHIJ' -PolicyID '987654321' -AlertName 'testAlert' -Enabled true -Entities 9999999 `
    -Metric error_percentage -ConditionScope application -ViolationCloseTimer 24 -TermsDuration 120 -TermsOperator above -TermsPriority critical `
    -TermsThreshold 5 -TermsTimeFunction all -RunbookURL 'http://runbook.com'
...
Function New-NRKeyTransactionAlert {
    ...
    Param (
        ...
        [ Parameter ( Mandatory = $true ) ] [ ValidateSet( 'apdex', 'error_percentage', 'error_count', 'response_time', 'throughput' ) ] [ string ] $Metric,
